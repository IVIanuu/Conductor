...
import com.ivianuu.conductor.preference.R;
...
public abstract class PreferenceController extends Controller implements
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        ...
        if (preference instanceof EditTextPreference) {
            f = EditTextPreferenceDialogController.Companion.newInstance(preference.getKey());
        } else if (preference instanceof ListPreference) {
            f = ListPreferenceDialogController.Companion.newInstance(preference.getKey());
        } else if (preference instanceof AbstractMultiSelectListPreference) {
            f = MultiSelectListPreferenceDialogController.Companion.newInstance(preference.getKey());
        } else {
