 ...
 */
package com.ivianuu.conductor.sample.changehandler.transitions
...
class FabTransform(private val color: Int, private val icon: Int) : Transition() {
    ...
    override fun createAnimator(
        ...
        if (dialogView != null) {
            val dialogViewFade =
                ObjectAnimator.ofInt(dialogView, "alpha", 0).setDuration(twoThirdsDuration)
